                                    ...
                                    <div class="lg:w-1/2 md:w-2/3 mx-auto">
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="mt-20 p-2 w-full">
                                                ...
                                                <button @click="deleteItem(item.id)" class="flex mx-auto  text-white bg-red-600 border-0 py-2 px-8 focus:outline-none hover:bg-red-500 rounded text-lg">削除する</button>
                                            </div>
