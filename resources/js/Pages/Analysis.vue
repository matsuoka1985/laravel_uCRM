                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 text-gray-900">
                        <form @submit.prevent="getData">
                            分析方法<br>
                            <input type="radio" name="formType" v-model="form.type" value="perDay" checked > <span class="mr-2">日別</span>
                            <input type="radio" name="formType" v-model="form.type" value="perMonth"  > <span class="mr-2">月別</span>
                            <input type="radio" name="formType" v-model="form.type" value="perYear"  > <span class="mr-2">年別</span>
                            <input type="radio" name="formType" v-model="form.type" value="decile"  > <span class="mr-2">デシル分析</span>
                            <input type="radio" name="formType" v-model="form.type" value="rfm"  > <span class="mr-2">RFM分析</span>
                            <br>
...
$form.rfmPrms
配列形式で、RFM分析する際の実際にどのような数値よりも大きければあるいは小さければどのランクになるかを決定するための指標。
ユーザーによって入力されるものだが、あらかじめ初期値にそれっぽいものを入れておく。
 -->
